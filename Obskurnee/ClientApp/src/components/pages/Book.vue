...
<section>
  ...
  <div class="main">
    ...
    <div class="buttons" v-if="!hideForm">
      <button @click="addReview" class="button-primary" tabindex="3">{{$t('menus.add')}}</button>
      <button @click="toggleVisibility" class="button-secondary button-hide" tabindex="5">{{$t('menus.hide')}}</button>
    </div>
  </div>
